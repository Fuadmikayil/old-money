...
const ProductCard = ({ item }) => {
  ...
  return (
      <div
        onClick={demo}
        className="w-1/5 flex flex-col gap-4 cursor-pointer border border-gray-600 rounded-xl overflow-hidden"
      >
        ...
        <div className="flex gap-4 justify-center items-center">
          ...
          <p className="text-emerald-200 text-2xl tracking-wide">
            {item.price}
          </p>
        </div>
